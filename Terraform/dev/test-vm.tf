...
resource "azurerm_linux_virtual_machine" "main" {
  ...
  provisioner "remote-exec" {
    ...
    provisioner "local-exec" {
        command = "ansible-playbook -u ${var.username} -i '${azurerm_linux_virtual_machine.main.public_ip_address},' --extra-vars \"ansible_password=${var.password}\" ../../Ansible/install.yml"
    }
}